            ...
            while (true) {
                ...
                switch (s) {
                    case "1":
                        ...
                        System.out.print("Enter client numberPhone: ");
                        String sNumberPhone = sc.nextLine();
                        long numberPhone = Long.parseLong(sNumberPhone);

                        dao.addClient(name, age, numberPhone);
                        break;
                    case "2":
